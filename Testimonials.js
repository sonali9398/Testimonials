...
const Testimonials = (props) => {
  ...
  return (
    ...
    items-center mt-10 p-10 transition-all duration-700 mx-auto hover:shadow-2xl rounded-lg'>
        <Card review = {reviews[index]}></Card>

       <div className='flex text-3xl mt-10 gap-3 text-violet-400 font-bold mx-auto tracking-wider'>
        <button 
